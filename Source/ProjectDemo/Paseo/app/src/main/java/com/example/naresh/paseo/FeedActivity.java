...
public class FeedActivity extends AppCompatActivity implements AsyncResponse {
    ...
    ArrayList<String> PuratingList = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setAdapter(new CustomAdapter(this,FromList,ToList,DateList,TimeList,MobileList,OidList,PuidList,PunameList,PuratingList,RuidList,RstatusList));
    ...
    public void processFinish(String output){
        ...
        try {
            ...
            for (int i = 0; i < reader.length(); i++) {
                ...
                String purating=jsonobject.getString("purating");
                ...
                PuidList.add(puid);
                PunameList.add(puname);
                PuratingList.add(purating);
                RuidList.add(ruid);
...
class CustomAdapter extends BaseAdapter {
    ...
    public ArrayList<String>  Puratingresult;
    public ArrayList<String>  Ruidresult;
    public ArrayList<String>  Rstatusresult;
    Context context;
    //int [] imageId;
    private static LayoutInflater inflater=null;
    public CustomAdapter(FeedActivity feedActivity, ArrayList<String>FromList,ArrayList<String>  ToList,ArrayList<String>  DateList,ArrayList<String> TimeList,ArrayList<String> MobileList,ArrayList<String>OidList,ArrayList<String>PuidList,ArrayList<String>PunameList,ArrayList<String>PuratingList,ArrayList<String>RuidList,ArrayList<String>RstatusList) {
        ...
        this.Puratingresult=PuratingList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.takeride_row, null);
        ...
        holder.Reqbutton=(Button) rowView.findViewById(R.id.button_request);
        holder.info=(TextView) rowView.findViewById(R.id.Info_textView);
        holder.uname=(TextView) rowView.findViewById(R.id.textView_uname);
        holder.uname.setText(Punameresult.get(position));
        ...
        if(Ruidresult.get(position).equals(ud.getoid())){
            holder.Reqbutton.setVisibility(View.GONE);
        ...
        holder.Reqbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    j.put("runame",ud.getfname());
                    j.put("rstatus","Requsted");
                    j.put("rmobile",ud.getmobile());
